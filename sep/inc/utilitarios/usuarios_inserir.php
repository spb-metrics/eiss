...
<?php
	...
	if($_POST["btCadastrar"] == "Inserir"){
		mysql_query("INSERT INTO usuarios SET nome = '$nome', login = '$login', senha = md5('$senha'), tipo = 'prefeitura', nivel = '$nivel'");
	...
	if($_POST["btEditar"] == "Editar"){
		...
		mysql_query("UPDATE usuarios SET nome = '$nome', login = '$login', senha = md5('$senha'), nivel = '$nivel' WHERE codigo = '$codedit'");
