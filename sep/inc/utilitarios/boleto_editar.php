...
mysql_query("UPDATE boleto SET tipo = '$tipo', codbanco = '$codbanco', agencia = '$agencia', contacorrente = '$contacorrente', convenio = '$convenio', contrato = '$contrato', carteira = '$carteira', codfebraban = '$codfebraban'");
