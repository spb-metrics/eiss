...
<table border="0" cellspacing="0" cellpadding="0" bgcolor="#CCCCCC">
	<tr>
		...
		<td width="650" background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">&nbsp;Nf-e - Liberar </td>
				...
				<table width="100%">
					...
					<tr>
						<td align="left" colspan="2">
							...
							onclick="acessoAjax('inc/nfe/liberar_lista.ajax.php','frmLiberarPrestNfe','divlistanfe')" />
						</td>
					</tr>
				</table>
				</fieldset>
