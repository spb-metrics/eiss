...
<?php
	...
	$query = ("
		...
		FROM 
			cadastro
		WHERE 
			estado = 'NL' AND codtipo = '6' $string
		ORDER BY 
			nome
		");
...
?>
	<table width="100%">
		...
		<tr bgcolor="#FFFFFF">
			...
			<td align="center">
				<input name="btLiberar" type="button" value="Ativar" class="botao" onClick="document.getElementById('hdCodSolicitacao').value=<?php echo $codigo;?>;acessoAjax('inc/instfinanceiras/liberar_lista.ajax.php','frmLiberarDif','divlistadif');alert('Cadastro ativado')">
			</td>
		</tr>
		<?php
			}//fim while
