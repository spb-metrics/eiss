...
if($acao == "Cadastrados"){
	...
	if($quant>0){
?>
	<fieldset><legend><b><?php echo $quant;?> - Prestadores cadastrados</b></legend>
	<table width="100%">
		<tr bgcolor="#999999">
			<td width="18%" align="center">Nomes</td>
			<td width="27%" align="center">Endere&ccedil;o</td>
			<td width="18%" align="center">Município</td>
...
<?php
	...
	if($quant>0){
?>
	<fieldset><legend><b><?php echo $quant;?> - Prestadores ativos</b></legend>
	<table width="100%">
		<tr bgcolor="#999999">
			<td width="18%" align="center">Nomes</td>
			<td width="27%" align="center">Endere&ccedil;o</td>
...
<?php
	...
	if($quant>0){
?>
	<fieldset><legend><b><?php echo $quant;?> - Prestadores inativos</b></legend>
	<table width="100%">
		<tr bgcolor="#999999">
			<td width="18%" align="center">Nomes</td>
			<td width="27%" align="center">Endere&ccedil;o</td>
