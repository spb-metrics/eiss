			...
			<tr>
				<td align="left" colspan="2">
					<input name="btTodas" type="button" class="botao" value="Todos os solicitantes"  
				     onclick="acessoAjax('inc/prestadores/relatorios/solicitacoes_aidf.ajax.php','frmRelatoriosPrestadores','divaidf')"/>
				</td>
			</tr>
		</table>
		<div id="divaidf"></div>
	...
	<fieldset><legend>Relatórios - Aidfe</legend>
		<table width="100%" cellpadding="3" cellspacing="3">
			...
			<tr>
				<td align="left" colspan="2">
					<input name="btTodas" type="button" class="botao" value="Todos os solicitantes"  
				     onclick="acessoAjax('inc/prestadores/relatorios/solicitacoes_aidfe.ajax.php','frmRelatoriosPrestadores','divaidfe')"/>
				</td>
			</tr>
		</table>
		<div id="divaidfe"></div>
		...
		<table width="100%" cellpadding="3" cellspacing="3">
			...
			<tr>
				<td align="left">
					...
					acessoAjax('inc/prestadores/relatorios/prestadores.ajax.php','frmRelatoriosPrestadores','divprestadores')">
				</td>
		...
		<table width="100%" cellpadding="3" cellspacing="3">
			...
			<tr>
				<td align="left">
					...
					acessoAjax('inc/prestadores/relatorios/contadores.ajax.php','frmRelatoriosPrestadores','divcontadores')">
				</td>
