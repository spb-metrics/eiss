...
?>
	...
	<table width="100%">
		<tr bgcolor="#999999">
			<td width="55%" align="center">Nome</td>
			<td width="18%" align="center">Ultima nota emitida</td>
			<td width="15%" align="center">Limite de notas</td>
			<td width="12%" align="center">Solicitações</td>
		</tr>
		<?php
		...
		<tr bgcolor="#FFFFFF">
			<td width="55%" align="left"><?php echo $nome;?></td>
			<td width="18%" align="center"><?php echo $ultimanota;?></td>
			<td width="15%" align="center"><?php echo $notalimite;?></td>
			<td width="12%" align="center"><?php if($cont == 0){$cont="Não solicitou";} echo $cont;?></td>
		</tr>
		<?php
			}//fim while
		?>
