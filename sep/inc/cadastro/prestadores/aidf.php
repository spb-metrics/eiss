...
<table border="0" cellspacing="0" cellpadding="0" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <form method="post" id="frmAidf" onsubmit="return false">
        ...
        <fieldset style="width:663px;"><legend>Pesquisar Solicitações</legend>
            <table width="100%" border="0" cellpadding="2" cellspacing="2">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td><input type="submit" name="btBusca" value="Buscar" class="botao" 
                    onclick="acessoAjax('inc/prestadores/aidf_busca.php','frmAidf','divaidf')" /></td>
                </tr>
            </table>		
        </fieldset>
        <div id="divaidf"></div>
