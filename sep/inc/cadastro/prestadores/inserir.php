...
if(!$nfe){ $nfe = "N";}
	...
	if(mysql_num_rows($teste_nome)>0){
	   ...
	   if($codtipo == $codtipo_inst){
		...
		2- Clique no link da sua respectiva declaração<br>
		3- Entre em acessar o sistema<br>
		3- Em login insira o cpf/cnpf da empresa<br>
		4- Sua senha é <b><font color=\"RED\">$senha</font></b><br>
		5- Insira o código de verificação que aparece ao lado<br>
		6- Depois de ter acessado o sistema, vá no link <br>atualizar cadastro</b> e troque sua senha<br>";
