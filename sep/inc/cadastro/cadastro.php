...
?>
	...
	<div id="divBusca"  ><?php include("inc/cadastro/busca.php"); ?></div> 
    ...
    <td align="center">
      ...
      <table border="0" align="center" id="tblEmpresa">	   
	   <tr>
        ...
        <td align="left">
	     <input type="text" size="70" maxlength="100" name="txtInsNomeEmpresa" class="texto" value="<?php echo $nome; ?>" >		</td>
       </tr>
       <tr>
        <td align="left">
		 Razão Social<font color="#FF0000">*</font>		</td>
        <td align="left">
	     <input type="text" size="70" maxlength="100" name="txtInsRazaoSocial" class="texto" value="<?php if(isset($razaosocial)){echo $razaosocial;} ?>">		</td>
       </tr>	   	
       ...
       <tr>
        ...
        <td align="left">			
		 <input  id="txtInsCpfCnpjEmpresa" type="text" size="20"  name="txtInsCpfCnpjEmpresa" class="texto" onkeydown="return NumbersOnly( event );" onkeyup="CNPJCPFMsk( this );" value="<?php if(isset($cnpjcpf)){echo $cnpjcpf;} ?>" /> 
       ...
       <tr>
        ...
        <td align="left">
		 <input type="text" size="70" maxlength="100" name="txtInsEnderecoEmpresa" class="texto" value="<?php if(isset($endereco)){echo $endereco;} ?>" />		</td>
       </tr>
       <tr>
	     <td align="left">
		  Município<font color="#FF0000">*</font>		 </td>
	     <td align="left">
          <input type="text" size="30" maxlength="100" name="txtInsMunicipioEmpresa" class="texto" value="<?php if(isset($municipio)){echo $municipio;} else{echo $dados_municipio['cidade'];} ?>" />		 </td>
	     </tr>
       <tr>
         <td align="left">UF<font color="#FF0000">*</font></td>
         <td align="left"><input type="text" size="3" maxlength="2" name="txtInsUfEmpresa" class="texto" value="<?php if(isset($uf)){echo $uf;} else{echo $dados_municipio['estado'];} ?>" /></td>
       </tr>
	   <tr>
        <td align="left">
		 Insc. Municipal		</td>
        <td align="left">
		 <input type="text" size="20" maxlength="20" name="txtInsInscMunicipalEmpresa" class="texto" value="<?php if(isset($inscrmunicipal)){echo $inscrmunicipal;} ?>" />		</td>
       </tr>
       <tr>
        <td align="left">
		 Email<font color="#FF0000">*</font>		</td>
        <td align="left">
		  <input type="text" size="30" maxlength="100" name="txtInsEmailEmpresa" class="texto" value="<?php if(isset($email)){echo $email;} ?>" /> 
		  <em>Informar somente 01	(um)	e-mail</em></td>
       </tr>
	   <tr>
	     <td align="left">Simples Nacional</td>
	     <?php $codsimples = codtipodeclaracao("Simples Nacional");?>
	     <td align="left"><input type="checkbox" value="S"  name="txtSimplesNacional" <?php if($simplesnaconal == $codsimples){echo "checked=\"checked\"";} ?>/>           <em>Esta empresa esta enquadrada no SN, conforme Lei Complementar n°123/2006</em></td>
	   </tr>
	   <tr>
		 ...
		 <tr>
		 	<td colspan="2" align="left">
				...
				if(($_POST['CODEMISSOR'])){
					...
					$sql=mysql_query("SELECT codigo, nome, cpf FROM cadastro_resp WHERE codemissor = '$COD'");	
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="2">  
					<tr>	
					 ...
					 <?php
					  ...
					  SELECT cadastro_servicos.codigo,servicos.codigo,servicos.codservico,
					  servicos.descricao,servicos.aliquota 
					  FROM servicos
