...
<?php
	...
	$sqlnumero = mysql_query("SELECT nrotif, anotif, datainicial, datafinal, dias, observacoes, intimacao, codlegislacao FROM processosfiscais_tif WHERE nroprocesso = '$nroprocesso' AND anoprocesso = '$anoprocesso'");
	list($nrotif, $dataini, $anotif, $datafim, $nrodias, $obs, $intimacao, $legislacao) = mysql_fetch_array($sqlnumero);
...
<?php
	...
	$datafim = implode("/", array_reverse(explode("-", $datafim)));
		...
		WHERE processosfiscais_tif.nrotif = '$nrotif' AND processosfiscais_tif.anotif = '$anoprocesso' ORDER BY processosfiscais_docs.nrodoc");
		
		?><table align="center" width="80%"><?php
...
<table width="700" align="center">
	...
	<tr>
		<td align="justify">
			...
			<?php while(list($doc_nro,$doc_descricao) = mysql_fetch_array($sqldocs)){
