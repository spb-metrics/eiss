...
<?php
	...
	$sql_docs=mysql_query("SELECT processosfiscais_docs.nrodoc, processosfiscais_docs.descricao FROM processosfiscais_docs INNER JOIN processosfiscais_ted_docs ON processosfiscais_docs.codigo=processosfiscais_ted_docs.coddoc WHERE processosfiscais_ted_docs.codted='$codted'");
...
<table width="700" align="center">
	<tr>
		<td align="justify">
			Viemos através deste confirmar a V.Sª que recebemos os documentos solicitados a V.S.ª no Termo de Recebimento de Documentos <?php echo "$nroted/$anoted"; ?>, referente ao Processo Fiscal <?php echo "$nroprocesso/$anoprocesso"; ?>, movido contra a empresa <?php echo $emissor; ?>
		</td>
	<tr>	
		<td align="justify">
			Este Termo de Recebimento de Documentos é emitido no dia <?php echo $dataemissao; ?>, sob as seguintes observações:
		</td>
	</tr>	
		<td>
