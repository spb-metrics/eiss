...
<table>
							<?php
							//Comando sql que selecionará do banco os tipos de prestadores e a quantidade de cada e o total geral

							$sql_tipo = mysql_query("select tipo.nome, count(cadastro.codigo) from cadastro 
							inner join tipo on tipo.codigo=cadastro.codtipo
							group by tipo.nome");
							echo "<b><center><font class=\"fonte\">Tipos de Prestadores</center></b> <br>";
							
							$qtdtotal=0;
							while(list($nome,$qtd)=mysql_fetch_array($sql_tipo)){
								echo"<tr><td align=\"center\"><font class=\"fonte\">$nome:</td><td align=\"center\"><font class=\"fonte\">$qtd</td></tr>";
								$qtdtotal=$qtdtotal+$qtd;
								}
							?>
							<tr>
								<td align="center"><font class="fonte"> Total:</td><td><?php echo "<font class=\"fonte\"> $qtdtotal"; ?></td>
					 		</tr>
		  </table>
...
$sql = mysql_query ("SELECT uf , COUNT(*) FROM cadastro WHERE uf != '' AND codtipo > 0  GROUP BY uf");
...
echo"<td align=\"center\" ><font class=\"fonte\">$uf:</td><td align=\"center\"><font class=\"fonte\">$qtd</td>";
$qtdtotal=$qtdtotal+$qtd;
...
?>
    ...
    <tr>
        <td align="left"><font class="fonte">Total:</td><td><?php echo "<font class=\"fonte\">$qtdtotal"; ?></td>
    </tr>
      </table>
      </td>
		<td width="34%" valign="top">
...
<?php
 ...
 //caso não encontre resultados, a mensagem 'Não há resultados!' será mostrada na tela
	echo "<center><b><font class=\"fonte\">Não há resultados!</b></center>";
