...
<form id="frmRelatorios" method="post" target="_blank" action="inc/relatorios/imprimir.php"><fieldset>
...
<select name="cmbCodtipo" id="cmbCodtipo" class="combo" >
						<option value=""></option>
						<?php
							$sql_codtipo = mysql_query("SELECT codigo, tipo, nome FROM tipo ORDER BY tipo");
			...
			<tr>
				...
				<td colspan="6" align="left">
					<div  id="txtInsMunicipioEmpresa">
						<select name="txtInsMunicipioEmpresa" id="txtInsMunicipioEmpresa" class="combo" style="width:150px"></select>
					</div>				</td>
			</tr>
            <tr>
