...
<table border="0" cellspacing="0" cellpadding="0" bgcolor="#CCCCCC">
  <tr>
    ...
    <td background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">&nbsp;Servi&ccedil;os - Contas de Instituição Financeira</td>  
  ...
  <tr>
    ...
    <td align="center">
		...
		if($_POST['servicos']!='Pesquisar') {
			include 'if_cadastrar.php';
		} else {
			include 'if_servicos.php';
		}
		?>
		<form method="post">
    	...
    	id('btCadastrar').onclick = function() {
			...
			if(form) {
				...
				form.appendChild(input);*/
				campoHidden('btCadastrar','Salvar',form);
				if(form.id=='frmCadastro')
					if(ValidaFormulario('txtInsConta|txtInsDescricao|cmbEstado'))
						form.submit();
