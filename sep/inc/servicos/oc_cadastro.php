...
<table border="0" cellspacing="0" cellpadding="0" bgcolor="#CCCCCC">
  <tr>
    ...
    <td background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">&nbsp;Servi&ccedil;os - Contas de Operadoras de Crédito</td>  
  ...
  <tr>
    ...
    <td align="center">
		...
		if($_POST['servicos']!='Pesquisar') {
			include 'oc_cadastrar.php';
		} else {
			include 'oc_servicos.php';
		}
		?>
		<form method="post">
