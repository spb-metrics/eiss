...
$conta = $_GET['txtBuscaConta'];
$descricao = $_GET['txtBuscaDescricao'];
...
while(list($estado,$descricao,$conta,$codigo)=mysql_fetch_array($sql)){ 
	...
	?>
	  <tr>
		<td align="left"  bgcolor="#FFFFFF"><?php echo $conta; ?></td>
		<td align="center"  bgcolor="#FFFFFF"><?php echo ResumeString($descricao,55); ?></td>
		<td align="center"  bgcolor="#FFFFFF"><?php echo $estado; ?></td>
		<td align="center">
			<a onclick="
				document.getElementById('COD').value='<?php echo $codigo; ?>';
				campoHidden('servicos','Pesquisar','frmBusca');
