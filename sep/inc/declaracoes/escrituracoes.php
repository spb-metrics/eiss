					...
					if(mysql_num_rows($sql)!=0)
					{
						if($pago == "N")
						{
							...
							if($valornossonumero == $valor)
							{
								...
								add_logs('Alterou uma Guia de Pagamento');
	...
	while($x<count($nossonum)){
		...
		");
		 ...
		 if(mysql_num_rows($sql)){
			...
			?>
					<tr>
						<td align="center" bgcolor="FFFFFF"><?php echo $nome ?></td>
						<td align="center" bgcolor="FFFFFF"><?php echo $nossonumero ?></td>
						<td align="center" bgcolor="FFFFFF"><?php echo $pago ?></td>
					</tr>
			<?php
			...
			?>
					<tr>
						...
						<td align="center" bgcolor="#ffac84"><?php echo $nossonumero ?></td>
