...
function mostraDetalhes(codigo,retorno){
	...
	ajax({
		url:'inc/cadastro/liberar_detalhes.ajax.php?cod='+codigo+'&a=a',
		espera: function(){
...
function ativarCadastro(codigo,retorno){
	ajax({
		url:'inc/cadastro/liberar_ativar.ajax.php?codativar='+codigo+'&a=a',
		espera: function(){
			document.getElementById(retorno).innerHTML = 'Verificando...';
		},
		sucesso: function(){
...
function removerCadastro(codigo,retorno){
	if(confirm('Deseja remover este cadastro?')){
		ajax({
			url:'inc/cadastro/liberar_remover.ajax.php?codremover='+codigo+'&a=a',
			espera: function(){
				document.getElementById(retorno).innerHTML = 'Verificando...';
			},
			sucesso: function(){
