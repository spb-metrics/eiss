...
/**Fun��o criaSpanSenha
*Parametro:
*elemento = nome do elemento da fun��o onload
*Esta fun��o cria um span ao lado do input de senha para que o mesmo receba uma resposta
*/
...
*idretorno = id do elemento que recebera o retorno da fun��o
*Esta fun��o verifica se o cnpj/cpf que foi digita j� existe no DB
