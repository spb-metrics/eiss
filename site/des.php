    ...
    <td bgcolor="#FFFFFF" height="400" valign="top" align="center">
		...
		<table height="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
		    ...
		    <td width="590" height="100" align="center" valign="top"><img src="../img/cabecalhos/des.jpg" width="590" height="100" /></td>
		  </tr>
		  <tr>
		    <td align="center" valign="top">
			<?php
			if(!($_POST['txtMenu'])){
			 	include("../include/des/links.php");
			}
			else{
			 	include("../include/des/index.php");
			}					
			?>    
		    </td>
		  </tr>
