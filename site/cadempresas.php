...
<table height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="590" height="100" align="center" valign="top"><img src="../img/cabecalhos/cec.jpg" width="590" height="100" /></td>
  </tr>
  <tr>
    ...
    <!-- box de conteúdos -->    																																												
	 <?php
		if($_POST["txtMenu"]){
			include("inc/cadempresas/".$_POST["txtMenu"].".php");
		}else {
			include("inc/cadempresas/links.php");
		} // fim else
	 ?>    
    </td>
  </tr>
