...
<table height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="590" height="100" align="center" valign="top"><img src="../img/cabecalhos/doc.jpg" width="590" height="100" /></td>
  </tr>
  <tr>
    <td align="center" valign="top">
	 <?php
		if ($_POST['txtMenu'] == "../include/doc/cadastro"){
			include($_POST['txtMenu'].".php");
		}elseif(!($_POST['txtMenu'])){
			include("../include/doc/links.php");
		}
		else{
