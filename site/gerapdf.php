...
$sql = mysql_query("SELECT codigo, nome, cnpjcpf FROM cadastro_emissores WHERE codigo = '110'");
...
$paragrafo02 = "A SOLICITAO DE DESBLOQUEIO DE ACESSO AO SISTEMA ISS Digital dever ser entregue na Prefeitura Municipal. Sem isso, o acesso e informaçoes de interesse exclusivo da pessoa física/jurdica supramencionada, nao pode ser desbloqueada.\n
Apresentar documento original do outorgante com fotografia para possibilitar a conferncia da assinatura pelo servidor responsvel. Para os casos em que o signatario desta Solicitaçaoo de Desbloqueio de Acesso ao Sistema ISS Digital for procurador, obrigatrio anexar a procuraçao do interessado, autorizando o procurador a representá-lo neste ato, e documento original do outorgante com fotografia para possibilitar a conferncia da assinatura pelo servidor responsável.\n
Esta solicitao tem validade de 60 (sessenta) dias a partir de sua emissao.";
$pdf->SetY("155");
$pdf->SetX("10"); 
