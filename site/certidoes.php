  ...
  <tr>
    <td bgcolor="#FFFFFF" height="400" valign="top" align="center">
		...
		<table height="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
			<td width="170" rowspan="2" align="left" valign="top" background="../img/menus/menu_fundo.jpg">
			<?php include("inc/menu.php"); ?></td>			
    <td width="590" height="100" align="center" valign="top"><img src="../img/cabecalhos/certidoes.jpg" width="590" height="100" /></td>
		  </tr>
		  <tr>
		  <td align="center" valign="top">	
		  
		    <?php
		  	if((!($_POST['txtMenu'])) && (!($_SESSION['SESSAO_menu_certidoes'])))
			{
			 include("inc/certidoes/links.php");
			}			
			else
			{
				include("inc/certidoes/index.php");
