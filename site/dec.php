...
<table height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="590" height="100" align="center" valign="top"><img src="../img/cabecalhos/dec.jpg" width="590" height="100" /></td>
  </tr>
  <tr>
    ...
    <?php
	 ...
	 if(!($_POST['txtMenu'])){
	 	include("../include/dec/links.php");
	}
	else{
	 	include("../include/dec/{$_POST['txtMenu']}");
	}					
	 ?>        
    </td>
  </tr>
