...
if($_POST['btCadastrar'] == "Cadastrar"){
	if((strlen($cpfcnpj_prestador) == 18) || (strlen($cpfcnpj_prestador) == 14)){
		...
		if(mysql_num_rows($sql_verifica_prestador)>0){
			...
			Mensagem("Sua reclamação foi enviada com sucesso!");
		...
		Mensagem("Digite um CPF/CNPJ de prestador valido!");
	}
}
?>
			...
			<td height="60" colspan="3" bgcolor="#CCCCCC">
				<table width="99%" border="0" align="center" cellpadding="5" cellspacing="0">
					<tr>
						...
						<td align="left" background="../../img/index/index_oquee_fundo.jpg"> ISS Digital </td>
					</tr>
					<tr>
						...
						<td align="left" background="../../img/index/index_oquee_fundo.jpg">
							<select name="cmbEspecificacao" id="cmbEspecificacao" class="combo">
							  <option value="Diferen&ccedil;a de valores ">Diferen&ccedil;a de valores </option>
							  <option value="Nota n&atilde;o declarada">Nota n&atilde;o declarada</option>
							</select>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td width="222" align="left" background="../../img/index/index_oquee_fundo.jpg"> Cpf/Cnpj do Tomador de serviços<font color="#FF0000">*</font></b> </td>
					...
					<tr>
						<td background="../../img/index/index_oquee_fundo.jpg" align="left"> Número da Nota Fiscal <b><font color="#FF0000">*</font></b> </td>
						<td  background="../../img/index/index_oquee_fundo.jpg" align="left">
							<input type="text" class="texto" name="txtRpsNumero" id="txtRpsNumero">
					</tr>
					<tr>
						<td background="../../img/index/index_oquee_fundo.jpg" align="left"> Data de Emissão da Nota Fiscal <b><font color="#FF0000">*</font></b> </td>
						<td  background="../../img/index/index_oquee_fundo.jpg" align="left">
							<input type="text" class="texto" name="txtDataRps" id="txtDataRps" maxlength="10">
					</tr>
					<tr>
						<td background="../../img/index/index_oquee_fundo.jpg" align="left"> Valor da Nota Fiscal <b><font color="#FF0000">*</font></b> </td>
						<td  background="../../img/index/index_oquee_fundo.jpg" align="left">
