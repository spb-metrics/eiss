      ...
      <td align="left" bgcolor="#999999">
          <table>
              ...
              <tr>
                  ...
                  <td>
                      <input type="text" size="14" maxlength="14" name="txtCpfSocio<?php echo $cont; ?>" id="txtCpfSocio<?php echo $cont; ?>" class="texto" onkeypress="formatar(this,'000.000.000-00')"/><?php echo $obrigatorio; ?>
                  </td>
                  <td>
                      <?php
                        if($cont!=1){
