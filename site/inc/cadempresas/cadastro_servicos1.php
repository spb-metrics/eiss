  ...
  <tr id="camposservico<?php echo $contservico; ?>" style="display:<?php echo $display; ?>">
    <td align="left" bgcolor="#999999">
     ...
     <option value="">Categoria</option>
	  <?php
	  $sql_categoria=mysql_query("SELECT servicos_categorias.codigo,servicos_categorias.nome FROM servicos_categorias INNER JOIN servicos ON servicos_categorias.codigo=servicos.codcategoria WHERE servicos_categorias.codigo <> '32' AND servicos.estado='A' GROUP BY servicos_categorias.codigo ORDER BY servicos_categorias.nome") or die(mysql_error());
