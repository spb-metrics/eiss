          ...
          <table width="480" border="0" align="center" id="tblEmpresa">	   
           ...
           <!-- alterna input cpf/cnpj FIM-->   
            ...
            <tr>
                ...
                <td align="left"><input type="text" size="10" maxlength="100" name="txtNumero" id="txtNumero" class="texto" /></td>
            </tr>
            <tr>
                <td align="left">Complemento</td>
                <td align="left"><input type="text" size="10" maxlength="100" name="txtComplemento" id="txtComplemento" class="texto" /></td>
            </tr>
            <tr>
    ...
    <table width="480" border="0" cellspacing="1" cellpadding="2">
         ...
         <?php include("inc/cadempresas/cadastro_servicos.php")?>
           ...
           <tr>
			 ...
			 onclick="return  (ValidaFormulario('txtInsNomeEmpresa|txtInsRazaoSocial|txtCNPJ|txtLogradouro|txtNumero|txtBairro|txtCEP|txtFoneComercial|txtInsUfEmpresa|txtInsMunicipioEmpresa|txtInsEmailEmpresa|txtNomeSocio1|txtCpfSocio1|cmbCategoria1')) && (ConfereCNPJ(this)) && ((ValidaSenha('txtSenha','txtSenhaConf')))" /></td>
