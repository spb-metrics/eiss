...
$sql_emissor=mysql_query("SELECT codigo, nome, razaosocial, inscrmunicipal, 
						  ...
						  FROM cadastro 
						  WHERE cnpj='$tomador_CNPJ' OR cpf='$tomador_CNPJ' AND codtipo={$result->codigo}");
...
if(!$tem_guias) { 
?>
<form action="inc/certidoes/pagamentos_insercao.php" method="post" target="blank">
<table  width="100%" border="0" align="center" cellpadding="2" cellspacing="2">
  ...
  <tr>
     <td align="right" height="30" bgcolor="#CCCCCC">
        ...
        <input type="submit" value="Imprimir certidão de pagamento" class="botao">
...
<table align="center" border="0">
	  <tr>
		 <td align="center">Existem débitos em aberto com a Prefeitura Municipal.<br><br>Para imprimir sua Certidão de Pagamento, o prestador deverá quitar suas guias que foram geradas na Declaração Eletrônica de Serviços (DES).         </td>
	  </tr>
	  <tr>
