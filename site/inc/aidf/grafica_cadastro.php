...
<table width="580" border="0" cellpadding="0" cellspacing="1">
    ...
    <br /><br /> </td>
      <tr>
        <td align="left" background="../../img/index/index_oquee_fundo.jpg">
          ...
          <form action="inc/aidf/inserir.php" method="post" name="frmCadastroEmpresa" id="frmCadastroEmpresa">
          <table width="480" border="0" align="center" id="tblEmpresa">	   
           ...
           <!-- alterna input cpf/cnpj-->   
            ...
            <td align="left">
                ...
                onkeyup="CNPJCPFMsk( this );" onblur="ValidaCNPJ(this,'spanempresas');desabilitaSN(this,'txtSimplesNacional','ftDesc')" />
                <span id="spanempresas"></span>
            </td>
            </tr>
           <!-- alterna input cpf/cnpj FIM-->   
            ...
            <tr>
                ...
                <td align="left"><input type="text" size="60" maxlength="100" name="txtNumero" id="txtNumero" class="texto" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="left" id="tdCidades">
                    <select style="width:150px;" id="txtInsMunicipioEmpresa">
                        <option value=""><option/>
                    </select>
                    <!--ESTE SELECT ESTA COM A NOMENCLATTURA DE UM TEXT PARA MANTER A COMPATIBILIDADE DO ARQUIVO INSERIR.PHP COM TODOS OS ARQUIVOS DE CADASTRO DE EMPRESAS-->
    ...
    <table width="480" border="0" cellspacing="1" cellpadding="2">
         ...
         <?php include("inc/cadempresas/cadastro_servicos.php")?>
           ...
           <tr>
             <td align="left"><input type="submit" value="Cadastrar" name="btCadastrar" class="botao" onclick="return  (ValidaFormulario('txtInsNomeEmpresa|txtInsRazaoSocial|txtCNPJ|txtLogradouro|txtNumero|txtBairro|txtCEP|txtFoneComercial|txtInsUfEmpresa|txtInsMunicipioEmpresa|txtInsEmailEmpresa|txtNomeSocio1|txtCpfSocio1|cmbCategoria1')) && (ConfereCNPJ(this)) && (ValidaSenha('txtSenha','txtSenhaConf'))" /></td>
