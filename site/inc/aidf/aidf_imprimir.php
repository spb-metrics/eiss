...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="5">
		...
		<td align="center">
			<table border="0" cellspacing="5" cellpadding="0">
				<tr>
					...
					<?php $sql_logo = mysql_query("SELECT brasao FROM configuracoes") or die(mysql_error());
								list($brasao) = mysql_fetch_array($sql_logo); 
					?>
					<img src="../../../img/brasoes/<?php echo $brasao; ?>"></td>
					<td width="550" align="left" valign="top"> <span class="txtEstado">Estado 
						<?php echo estadoExtenso($CONF_ESTADO);	?>
						</span><br>
						<span class="txtPrefeitura">PREFEITURA MUNICIPAL DE 
						<?php echo strtoupper($CONF_CIDADE); ?>
						</span><br>
						<span class="txtSecretaria">
						<?php $sql_sec = mysql_query("SELECT secretaria FROM configuracoes") or die (mysql_error()); 
	...
	<tr>
		<td align="center">
			<table border="0" cellspacing="2" cellpadding="2" style="border:dotted thin">
				...
				<tr>
					<td align="left">Ao(s)<?php echo date("d"); ?> dia(s) do m&ecirc;s de <?php echo mesExtenso (date("m")) ; ?> do ano de <?php echo date("Y");?>, nesta <?php echo $sec;?>, com sede em <?php echo $CONF_CIDADE; ?> , recebi a solicita&ccedil;&atilde;o de libera&ccedil;&atilde;o dos documentos fiscais abaixo relacionados. </td>
				</tr>
			</table>
		</td>
	</tr>
	<tr>
		...
		<td align="center">
			<table border="0" cellspacing="2" cellpadding="2" style="border:dotted thin">
				...
				<tr>
					<td width="175" height="32" align="center" valign="top"><span class="tblLabel">Sub-s&eacute;rie</span><br>
					</td>
					<td width="175" align="center" valign="top"><span class="tblLabel">Esp&eacute;cie</span><br>
					</td>
					<td width="175" align="center" valign="top"><span class="tblLabel">N&deg; Inical </span><br>
					</td>
					<td width="175" align="center" valign="top"><span class="tblLabel">N&deg; Final </span></td>
					<td width="175" align="center" valign="top"><span class="tblLabel">Quantidade</span><br>
					</td>
					<td width="175" align="center" valign="top"><span class="tblLabel">Tipo</span><br>
					</td>
				</tr>
				<?php
			while(list($serie,$especie,$subserie,$nroinicial,$nrofinal,$quantidade,$tipo)=mysql_fetch_array($sql_docs)) {?>
				<tr>
					<td width="175" height="32" align="center" valign="top"><span class="tblLabel"><b><?php echo $serie; ?></b></span><br>
					</td>
					<td width="175" height="32" align="center" valign="top"><span class="tblLabel"><?php echo $subserie; ?></span><br>
					</td>
					<td width="175" align="center" valign="top"><span class="tblLabel"><?php echo $especie; ?></span><br>
					</td>
					<td width="175" align="center" valign="top"><span class="tblLabel"><?php echo $nroinicial; ?></span><br>
					</td>
					<td width="175" align="center" valign="top"><span class="tblLabel"><?php echo $nrofinal; ?></span><br>
					</td>
					<td width="175" align="center" valign="top"><span class="tblLabel"><?php echo $quantidade; ?></span><br>
					</td>
					<td width="175" align="center" valign="top"><span class="tblLabel"><?php echo $tipo; ?></span><br>
					</td>
				</tr>
				<?php
			  }
	...
	<tr>
		<td align="center">
			<table border="0" cellspacing="2" cellpadding="2" style="border:dotted thin">
				<tr>
					<td width="800" height="25" align="center" valign="middle" bgcolor="#CCCCCC" class="tblTitulo">DESCRI&Ccedil;&Atilde;O DO PEDIDO </td>
				</tr>
				<tr>
					<td align="left">
						<?php  
	...
	<tr>
		...
		<td align="center"><?php 
		$sql_link = mysql_query("SELECT 
								site FROM configuracoes") or die(mysql_error());
