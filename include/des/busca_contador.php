				...
				<table width="100%">
					...
					<tr>
						<td background="img/busca_fundo.jpg" align="center">
							<select name="CODCONTADOR" id="CODCONTADOR" size="13" style="width:277px; height: 200px; background-color:#255b8f;color:#FFFFFF;" class="combo" 
							onchange="document.getElementById('frmbuscacont').submit();">
								...
								if(isset($_POST['txtBuscaNome'])) {
									...
									FROM 
										cadastro 					
									WHERE
										razaosocial LIKE'%$nome%' AND codtipo = '$codtipo_cont' AND estado <> 'NL'
									ORDER BY
										razaosocial
									");
