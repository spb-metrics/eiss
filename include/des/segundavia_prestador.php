...
list($cod_emissor,$nome_emissor,$razao_emissor,$im_emissor,$logradouro_emissor,$numero_emissor,$complemento_emissor,
	...
	<table width="580" border="0" cellpadding="0" cellspacing="1">
		<tr>
		  ...
		  <td width="55%" align="center" bgcolor="#FFFFFF" rowspan="3" class="fieldsetCab">DES - Segunda Via da Guia de Pagamento</td>
		...
		<tr>
			...
			<table width="100%" height="100%" border="0" align="center" cellpadding="3" cellspacing="2">
				<tr>
					<td colspan="2" align="left"><strong>Prestador/Tomador: em caso de extravio da primeira via imprima sua segunda via.</strong></td>
				</tr>
				<tr>
				...
				<tr>
				  <td colspan="2" align="center" valign="top" id="Container">				  					  		
				  	<script>acessoAjax("include/des/segundavia.ajax.php","","Container");</script>
				  </td>
				</tr>     
			    <tr>
