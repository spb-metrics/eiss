...
$agencia            = trataString($_POST['txtAgencia']);
	...
	if(mysql_num_rows($teste_nome)>0){
		...
		2- Clique no link Operadoras de Crédito<br>
	   ...
	   //insere os socios no banco
		...
		mysql_query("INSERT INTO operadoras_creditos SET codbanco = '$banco', agencia = '$agencia', codcadastro = '$CODEMPRESA'");
		
		Mensagem("Operadora Cadastrada");
		?>

		<form method="post" id="frmComprovanteDif" action="../include/doc/comprovante.php" target="_blank">
