...
<?php 
	if($_POST['btEnviar']){
		include("include/doc/verifica_xml.php");
	}
?>
    <table border="0" cellspacing="1" cellpadding="0">
    	<tr>
            <td width="10" height="10" bgcolor="#FFFFFF"></td>
            <td width="400" align="center" bgcolor="#FFFFFF" rowspan="3">Arquivo de declaração mensal</td>
            ...
            <td height="60" colspan="3" bgcolor="#CCCCCC">
			  ...
			  <form  method="post" name="frmPagamento"   enctype="multipart/form-data" onsubmit="return VerificaArquivo();">   
				  ...
				  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2">	       
				    ...
				    <tr>
					<td width="30%" align="left" style="text-indent:30px;">
					 XML
					</td>
