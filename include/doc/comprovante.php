...
<?php
	...
	$sql_inst=mysql_query("SELECT codigo, razaosocial, logradouro, numero FROM cadastro WHERE cnpj = '$cnpj'");
	list($codigo,$razaosocial,$logradouro,$numero)=mysql_fetch_array($sql_inst);
?>
<div id="imprimir">
...
<table width="800" border="0" cellspacing="0" cellpadding="5" align="center">
  <tr>
	...
	<table border="0" cellspacing="0" cellpadding="5" style="border: 0px;">
      <tr>
        <td width="150" style="border:0px;" align="left"><img src="../../img/brasoes/<?php echo $LOGO; ?>"></td>
		...
		Comprovante de Cadastro de Operadora de cr&eacute;dito</font></td>
      </tr>
    </table></td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="center" colspan="2"><font class="prefeitura"><?php echo $codigo; ?></font></td>
  ...
  <tr>
    <td height="200" colspan="4" align="center" valign="middle"><span class="style1">A Prefeitura Municipal de <font class="prefeitura"><?php echo $CIDADE; ?></font> certifica que a Operadora de cr&eacute;dito citada acima foi devidamente cadastrada no sistema de ISSDigital do município<font class="prefeitura"><?php e ?></font>.</span>   </td>
  </tr>
  <tr>
    <td height="30" colspan="4" align="center" bgcolor="#CCCCCC"><strong>OBSERVA&Ccedil;&Otilde;ES</strong></td>
  </tr>
  <tr>
    <td colspan="4"><p>- A senha de acesso da Operadora de cr&eacute;dito ao sistema de ISSDigital do município é de uso exclusivo e intransferível da Operadora de cr&eacute;dito, bem como a responsabilidade sobre o uso indevido da mesma.
    </p></td>
  </tr>
  <tr>
