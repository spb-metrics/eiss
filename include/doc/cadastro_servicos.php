...
?>
 ...
 while($contservico <= $nroservicos) {
 	$contservico ==1?$style="style=\"display:block\"":$style="style=\"display:none\"";
 	$contservico==1?$ast="<font color=\"#FF0000\">*</font>":$ast="";
 	if($contservico==1){
 			$codCampoServico=$codcategoria.$contservico;
 	}

 	// sql para consultar o servico 
 ?>
<!------------------- SERVICO <?php print $contservico; ?> ------------------------------------------------------> 
  <tr id="linha01servico<?php echo $contservico; ?>" <?php echo $style;?>>	    	     	
	<td height="0"></td>
  </tr>
  <tr id="camposservico<?php echo $contservico; ?>" <?php echo $style;?>>	    
    <td align="left" bgcolor="#999999">
	 ...
	 <select name="cmbCategoria<?php echo $contservico; ?>" id="cmbCategoria<?php echo $contservico; ?>" onchange="ServicosCategorias(this);" style="width:400px;">
     <option value=""></option>
	  <?php	    
