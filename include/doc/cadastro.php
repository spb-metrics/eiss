...
<?php
	...
	if($_POST["btCadastrar"] == "Cadastrar"){
		include("../include/doc/inserir.php");
	}
?>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
	<tr>
        ...
        <td width="340" align="center" bgcolor="#FFFFFF" rowspan="3">Cadastro de Operadora de crédito</td>
...
<form method="post" name="frmAtualizaDoc" id="frmAtualizaDoc">
<input type="hidden" value="<?php echo $_POST['txtMenu'];?>" name="txtMenu">
    ...
    <!-- alterna input cpf/cnpj-->
        <tr>
            ...
            <td align="left">
                ...
                onblur="ValidaCNPJ(this,'spandoc')" /><span id="spandoc"></span>
            </td>
        </tr>
    <!-- alterna input cpf/cnpj FIM-->
        ...
        <tr>
            ...
            <td align="left"><input type="text" size="12" maxlength="10" name="txtAgencia" id="txtAgencia" class="texto" ></td>
        </tr>
        <tr>
                    ...
                    <select name="txtInsMunicipioEmpresa" id="txtInsMunicipioEmpresa" class="combo">
						<?php
                        	...
                        	while(list($nome) = mysql_fetch_array($sql_municipio)){
                        		echo "<option value=\"$nome\"";if(strtolower($CIDADE) == strtolower($nome)){ echo "selected=selected";} echo ">$nome</option>";
                        	}//fim while 
                        ?>
                    </select>
                </div>
        ...
        <tr>
            <td colspan="2" align="left ">
                <table width="480" border="0" cellspacing="1" cellpadding="2">
					<?php include("../include/doc/cadastro_socios.php");?>
                </table>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" align="left">
                <table width="480" border="0" cellspacing="1" cellpadding="2">
					<?php include("../include/doc/cadastro_servicos.php")?>
                </table>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="left">
                ...
                onclick="return (ValidaFormulario('txtEmpresa|txtRazao|txtCNPJ|txtLogradouro|txtNumero|txtBairro|txtCEP|cmbBanco|txtAgencia|txtFoneComercial|txtInsUfEmpresa|txtEmail|txtInsMunicipioEmpresa|txtNomeSocio1|txtCpfSocio1|cmbCargo1|cmbCategoria1') && ConfereCNPJ(this) && ValidaSenha('txtSenha','txtSenhaConf'))" /></td>
