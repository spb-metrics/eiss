...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
	<tr>
		...
		<td width="400" align="center" bgcolor="#FFFFFF" rowspan="3">Consulta ao Cadastro de Simples Nacional</td>
                ...
                <table width="100%" height="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td width="77%" align="left">
                            <input name="txtCNPJ" id="txtCNPJ" onkeyup="CNPJCPFMsk(this);" type="text" size="20" maxlength="18" class="texto" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            onClick="window.location='simples.php'">
                        </td>
                    </tr>
                </table>
        </form>
    ...
    <?php	
		...
		$buscatipo=coddeclaracao('Simples Nacional');
		$cnpj = $_POST["txtCNPJ"];
		...
		switch($estado){
				...
				case "I" : $estado = "<font color=\"#FF0000\">Instituição financeira inativa, entre em contato com a prefeitura.</font>"; break;
		}//fim switch estado
...
<table width="100%" border="0" cellpadding="0" cellspacing="1">
	<tr>
		...
		<td width="30%" align="center" bgcolor="#FFFFFF" rowspan="3">Consulta de Simples</td>
              ...
              <tr>
				...
				<tr>
					<td  height="25" colspan="4"><input type="button" name="btVoltar" value="Voltar" class="botao" 
                    	onClick="window.location='simples.php'"></td>
				</tr>
			</table>
          	</td>	
        </tr>
...
<?php
			...
			Mensagem("Este CNPJ/CPF não está cadastrado no sistema ou não é optante pelo simples nacional");
			Redireciona("simples.php");
		}
	}//fim else
?>