...
<?php
	...
	$stringSql = ("
		...
		INNER JOIN
			simples_des_servicos ON simples_des_servicos.codsimples_des = simples_des.codigo
		WHERE
		...
		?>                
		                <tr id="trDes<?php echo $cont;?>"<?php if($estado =='C'){ echo"style=\"background-color:#FFAC84\"";}?> >
		                  ...
		                  <td align="center" id="tdCancelar<?php echo $cont;?>">
		                  	<?php if($estado =='N'){?>
		                  		<input name="imgCancelar<?php echo $cont;?>" id="imgCancelar<?php echo $cont;?>" type="image" src="img/botoes/botao_cancelar.jpg" onClick="return desn.cancelarDeclaracao('<?php echo $cont;?>');">
		                  	<?php }else{echo "Canc";}?>
