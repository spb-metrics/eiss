	...
	if(mysql_num_rows($teste_nome)>0){
	   ...
	   $sql = mysql_query("
			...
			SET 
				...
				codtipodeclaracao=(SELECT codigo FROM declaracoes WHERE declaracao='MEI'),
				nome='$nome', 
				senha = md5('$senha'), 
	   ...
	   $socio=codcargo('responsavel');
		...
		print "<script language=JavaScript>alert('Cadastro feito com sucesso!!');window.location='../../site/mei.php'</script>"; 
	}
?>
