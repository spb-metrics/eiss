...
<!------------------- SERVICO <?php print $contservico; ?> ------------------------------------------------------> 
  <tr id="linha01servico<?php echo $contservico; ?>" style="display:<?php echo ($contservico==1)?'block':'none'; ?>">	    	     	
	<td height="1" bgcolor="#999999"></td>
  </tr>
  <tr id="camposservico<?php echo $contservico; ?>" style="display:<?php echo ($contservico==1)?'block':'none'; ?>">	    
