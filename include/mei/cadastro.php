 ...
 <!-- Formulário de inserção de empresa --> 
	...
	<table width="580" border="0" cellpadding="0" cellspacing="1">
        <tr>
	        ...
	        <td width="70%" align="center" bgcolor="#FFFFFF" rowspan="3">Cadastro MEI</td>
...
<tr>
  ...
  <tr>
    <td align="left" background="../../img/index/index_oquee_fundo.jpg">
      ...
      <form action="../include/mei/inserir.php" method="post" name="frmCadastroEmpresa" id="frmCadastroEmpresa">
      <table width="480" border="0" align="center" id="tblEmpresa">	   
	   ...
	   <!-- alterna input cpf/cnpj-->   
		...
		<td align="left">
			<input  type="text" size="18" name="txtCNPJ" id="txtCNPJ" class="texto" onblur="ValidaCNPJ(this,'spamMei')"/>
			<span id="spamMei"></span></td>
		</tr>
...
<table width="480" border="0" cellspacing="1" cellpadding="2">
	 ...
	 <?php include("../include/mei/cadastro_socios.php")?>
</table>
	   ...
	   <tr>
	     <td colspan="2" align="center">	 
<table width="480" border="0" cellspacing="1" cellpadding="2">
	 <?php include("../include/mei/cadastro_servicos.php")?>
</table>
