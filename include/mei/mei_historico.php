...
<form method="post" action="include/mei/mei_relatorio.php" target="_blank">
		...
		<tr height="30">
            ...
            <td width="5%">
            	<select name="cmbAno" class="combo">
                	<option value=""></option>
                <?php
					$sql_ano = mysql_query("SELECT SUBSTRING(competencia,1,4) FROM mei_des GROUP BY SUBSTRING(competencia,1,4) ORDER BY SUBSTRING(competencia,1,4) DESC");
