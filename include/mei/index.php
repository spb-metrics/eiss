...
?>
<?php 	
if((!$_POST['txtCNPJ']&&!$_POST['txtInscMunicipal']) || (!$_POST['txtMenu'] == "inc/simples/cadastro")){
...
<tr>
	    ...
	    <td width="165" align="center" bgcolor="#FFFFFF" rowspan="3">DESN - Informe seu dados</td>
	...
	<tr>
		...
		<table width="98%" height="100%" border="0" align="center" cellpadding="5" cellspacing="0">
			...
			<tr>
			  <td align="center">&nbsp;</td>
			  <td align="left" valign="middle"><input type="submit" value="Avançar" class="botao" onclick="return verificaCnpjCpfIm();" tabindex="5" /></td>
		  </tr>
	  </table>		</td>
	</tr>
	<tr>
...
<?php 
	...
	$sql=mysql_query("SELECT codigo FROM emissores WHERE cnpjcpf='$cnpj' AND senha='$senha' AND codtipo='$buscatipo' AND estado='A'");
	
	if(mysql_num_rows($sql)<1)
		{
			Mensagem("Login e/ou senha inválidos ou o emissor não é optante pelo simples nacional");
