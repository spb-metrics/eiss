...
?>
<form method="post" name="frmDesCemTomador" action="include/mei/geraguia.php" target="_parent" onsubmit="return confirm('Confira seus dados antes de continuar');">
...
<table width="580" border="0" cellpadding="0" cellspacing="1">
	<tr>
		...
		<td width="65%" align="center" bgcolor="#FFFFFF" rowspan="3" class="fieldsetCab">MEI - Micro Empreendedor Individual</td>
