...
?>
	<form method="post" name="frmDIF">
	<input type="hidden" value="<?php echo $_POST["hdAction"];?>" name="txtMenu">
	<input type="hidden" name="hdLogin" value="<?php echo $_POST["hdLogin"];?>"/>
<table border="0" cellspacing="1" cellpadding="0">
<tr>
		<td width="10" height="10" bgcolor="#FFFFFF"></td>
	    <td width="165" align="center" bgcolor="#FFFFFF" rowspan="3">DIF - Informe seu dados</td>
		...
		<table width="98%" height="100%" border="0" align="center" cellpadding="5" cellspacing="0">
			<tr>
			    ...
			    <td width="81%" align="left" valign="middle"><em>
			      <input class="texto" type="text" title="CNPJ" name="txtCNPJ"  id="txtCNPJ" tabindex="1" maxlength="18"  />
			...
			<tr>
			  <td align="center">&nbsp;</td>
			  <td align="left" valign="middle"><input type="submit" value="Avançar" class="botao" onclick="return verificaCnpjCpfIm();" tabindex="4" /></td>
		  </tr>
	  </table>		</td>
	</tr>
	<tr>
