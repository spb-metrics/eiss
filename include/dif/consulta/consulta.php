...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
	<tr>
		...
		<td width="400" align="center" bgcolor="#FFFFFF" rowspan="3">Consulta ao Cadastro de Institui&ccedil;&atilde;o Financeira</td>
    		...
    		<input type="hidden" value="<?php echo $_POST['txtMenu'];?>" name="txtMenu">
	            <table width="98%" height="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                	...
                	<tr>
                  		...
                  		<input name="btAvancar" type="submit" value="Avançar" class="botao" onclick="return verificaCnpjCpfIm();" />&nbsp;<input type="button" name="btVoltar" value="Voltar" class="botao" onClick="window.location='dif.php'">
                		</td>
            		</tr>
        		</table>
        </form>
...
");
	list($codigo,$nome,$razaosocial,$senha,$cnpj,$inscrmunicipal,$logradouro,$numero,$municipio,$bairro,$cep,$complemento,$uf,$email,$fonecomercial,$fonecelular,$estado,$codbanco,$agencia) = mysql_fetch_array($sql_instituicaologada);
		switch($estado){
			...
			case "I": $estado = '<font color="#FF0000"><b>Instituição Financeira Inativa, entre em contato com a prefeitura.</b></font>'; break;
		}//fim switch estado
                    ...
                    <table width="98%" height="100%" border="0" bgcolor="#CCCCCC" align="center" cellpadding="1" cellspacing="2">
                        ...
                        <tr>
                            <td  height="25" colspan="4"><input type="button" name="btVoltar" value="Voltar" class="botao" 
                                onClick="window.location='dif.php'"></td>
                        </tr>
                    </table>
            </form>		
        </td>	
