...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
	<tr>
		...
		<td width="340" align="center" bgcolor="#FFFFFF" rowspan="3">Cancelamento de Instituição financeira</td>
...
<form id="frmGuiaDif" method="post" name="frmGuiaDif" target="_parent">
	...
	$sql_guias = mysql_query("
		...
		WHERE
			cadastro.cnpj = '$inst_CNPJ' AND dif_des.estado = 'N'
		GROUP BY
			dif_des.codigo
		ORDER BY 
			dif_des.codigo DESC
...
$cont = 0;  
		...
		?>                
            <tr id="trDes<?php echo $cont;?>">
              ...
              <td align="center" id="tdCancelar<?php echo $cont;?>">
                <input name="imgCancelar<?php echo $cont;?>" id="imgCancelar<?php echo $cont;?>" type="image" src="img/botoes/botao_cancelar.jpg" onClick="return dif.cancelarDeclaracao('<?php echo $cont;?>');" title="Excluir Declaração">
              </td>
            </tr>
		<?php
			// incrementa contador
	...
	?>                  	              
			  ...
			  <tr>
			  	<td colspan="5"><input type="button" value="Voltar" class="botao" onclick="parent.location = 'dif.php'" ></td>
			  </tr>
		  </table>		
		  </td>
		</tr>
