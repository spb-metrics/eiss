...
$inst_CNPJ = $_SESSION['login'];
//verifica se tem o emissor cadastrado
$sql_instituicao = mysql_query("
	SELECT 
		codigo, 
		nome,
		razaosocial, 
	...
	WHERE 
		cnpj = '$inst_CNPJ'
");
$dados_operadoras = mysql_fetch_array($sql_instituicao);

	?>

	<form id="frmGuia" method="post" name="frmDesSegundaVia" action="include/dif/guia_pagamento/gerasegundavia_guia.php" target="_blank">
	<input type="hidden" name="hdCodGuia" id="hdCodGuia" value="" />
		
	<table width="580" border="0" cellpadding="0" cellspacing="1">
		<tr>
			<td height="10" bgcolor="#FFFFFF"></td>
		    <td align="center" bgcolor="#FFFFFF" rowspan="3">DIF - Segunda Via da Guia de Pagamento</td>
		...
		<tr>
			...
			<table width="98%" height="100%" border="0" align="center" cellpadding="5" cellspacing="0">
				...
				<tr>
				    ...
				    <td width="73%" align="left" valign="middle"><?php echo $inst_CNPJ; ?></td>
				</tr>
				<tr>
				  <td align="left" valign="middle">Inscri&ccedil;&atilde;o Municipal:</td>
				  <td align="left" valign="middle"><?php echo $dados_operadoras['inscrmunicipal'];?></td>
			  	</tr>
				<tr>
				  <td align="left" valign="middle">Raz&atilde;o Social:</td>
				  <td align="left" valign="middle"><?php echo $dados_operadoras['razaosocial'];?></td>
			  	</tr>
				<tr>
				  <td align="left" valign="middle">Endere&ccedil;o:</td>
				  <td align="left" valign="middle"><?php echo $dados_operadoras['logradouro'].", ".$dados_operadoras['numero']." - ".$dados_operadoras['municipio']." - ".$dados_operadoras['uf'];?></td>
			  	</tr>
				<tr>
...
<?php
		...
		$sql_guias = mysql_query("
			...
			INNER JOIN
				dif_des ON dif_des.codigo = guias_declaracoes.codrelacionamento
			INNER JOIN
				cadastro ON cadastro.codigo = dif_des.codinst_financeira 
			WHERE
				guia_pagamento.pago = 'N' AND cadastro.cnpj = '$inst_CNPJ' AND guias_declaracoes.relacionamento = 'dif_des'
			GROUP BY 
				codigo 
			ORDER BY 
				codigo DESC
