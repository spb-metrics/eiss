        ...
        <td align="left" background="../../img/index/index_oquee_fundo.jpg">
          ...
          <table width="480" border="0" align="center" id="tblEmpresa">  
           ...
           <!-- alterna input cpf/cnpj-->   
            ...
            <td align="left"><input type="text" size="18"  name="txtCNPJ" id="txtCNPJ" class="texto"  onkeydown="return NumbersOnly( event );" onkeyup="CNPJCPFMsk( this );" onblur="ValidaCNPJ('frmCadastroEmpreiteira','txtCNPJ','spamempreiteiras','empreiteiras.cnpj')" /><span id="spamempreiteiras"></span></td>
            </tr>
           <!-- alterna input cpf/cnpj FIM-->   
            <tr>
                <td align="left">Logradouro:<font color="#FF0000">*</font></td>
                <td align="left"><input type="text" size="60" maxlength="100" name="txtLogradouro" id="txtEndereco" class="texto" /></td>
            </tr>
            <tr>
                <td align="left">Número:<font color="#FF0000">*</font></td>
                <td align="left"><input type="text" size="60" maxlength="100" name="txtNumero" id="txtEndereco" class="texto" /></td>
            </tr>
            <tr>
