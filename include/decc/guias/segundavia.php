...
$endereco.=", ".$dados['bairro'];
	...
	<form id="frmGuia" method="post" name="frmDesSegundaVia" action="include/decc/guias/gerasegundavia_imprimir.php" target="_blank">
	...
	$sql_guias=mysql_query("SELECT guia_pagamento.codigo,
                            ...
                            ON guias_declaracoes.codguia = guia_pagamento.codigo
                            INNER JOIN decc_des
                            ON decc_des.codigo = guias_declaracoes.codrelacionamento
                            INNER JOIN cadastro
                            ON cadastro.codigo = decc_des.codempreiteira
                            WHERE guia_pagamento.pago = 'N'
                            AND cadastro.codigo = '".$dados['codigo']."'
                            AND guias_declaracoes.relacionamento = 'decc_des'
                            GROUP BY codigo
