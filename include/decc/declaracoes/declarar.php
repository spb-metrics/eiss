...
<form method="post" name="frmDesCemTomador" id="frmDesCemTomador" action="include/decc/declaracoes/declarar_sql.php" onSubmit="return confirm('Confira seus dados antes de continuar');">
		...
		<table width="580" border="0" cellpadding="0" cellspacing="1">
	        <tr>
		        ...
		        <td width="70%" align="center" bgcolor="#FFFFFF" rowspan="3">DECC - Declaração das Empresas de Construção Civil</td>
		...
		?>                  
				  ...
				  <tr>
					  <td align="left" valign="middle">&nbsp;</td>
					  <td align="left" valign="middle"><input type="submit" value="Declarar" class="botao" onClick="return ValidaFormulario('cmbMes|cmbAno|cmbCodServico1|txtBaseCalculo1|txtNroDoc1|cmbObra','O Período, uma obra e pelo menos um serviço devem ser preenchidos!');" /></td>
				  </tr>
			  </table>		
			  </td>
			</tr>
