...
<form method="post">
	...
	<table>
		<tr>
			...
			<td><input type="submit" class="botao" name="btBuscar" value="Buscar" onclick="return ValidaFormulario('_mes|_ano','Por favor selecione um mes e um ano!')"/></td>
		</tr>
        <tr>
	</tr>
	<tr>
...
<?php
	if($_POST["btBuscar"]=="Buscar")
		{
			$cnpj=$_SESSION["login"];
			$sql_cartorio=mysql_query("SELECT codigo FROM cadastro WHERE cnpj='$cnpj'");
			list($codcartorio)=mysql_fetch_array($sql_cartorio);
			...
			if(mysql_num_rows($sql)>0)
				{
					?>
						<form method="post" onsubmit="return confirm('Confirmar?');">
							...
							<input type="hidden" name="txtEmissor" value="<?php echo $codcartorio;?>" />
							<table width="90%">
								<tr bgcolor="#999999">
									<td colspan="4" width="98%" align="right">Selecionar tudo</td>
						 	...
						 	<table>
								<tr>
									<td>Valor Imposto</td>
									<td>
										<input type="text" class="texto" style="text-align: right" name="txtTotalIss" id="txtTotalIss" value="0,00" readonly="yes" >
									</td>
								</tr>
                                <tr>
                                	<td>Multa</td>
                                	<td>
                                		<input type="text" class="texto" style="text-align: right" name="txtMultaJuros" id="txtMultaJuros" value="0,00" readonly="yes" >
                                	</td>
                               	</tr>
                                <tr>
                                	<td>Total a pagar</td>
                                	<td>
                                		<input type="text" class="texto" style="text-align: right" name="txtTotalPagar" id="txtTotalPagar" value="0,00" readonly="yes" >
                                	</td>
                                </tr>
								<tr>
									<td></td>
	...
	<tr>
        <td height="1" colspan="3" bgcolor="#CCCCCC"></td>
							...
							<input type="submit" class="botao" value="Gerar Boleto" name="btBoleto" id="btBoleto" onclick="document.getElementById('btBoleto').disabled; return ValidaCkbDec('txtTotalIss')"/>
