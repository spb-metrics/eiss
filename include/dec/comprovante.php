...
<?php
	...
	$sql_inst=mysql_query("SELECT codigo, nome, logradouro, numero FROM cadastro WHERE cnpj='$cnpj'");
	list($codigo,$razaosocial,$logradouro, $nrologradouro)=mysql_fetch_array($sql_inst);
?>
<div id="imprimir">
...
<table width="800" border="0" cellspacing="0" cellpadding="5" align="center">
  ...
  <tr>
    ...
    <font class="prefeitura"><?php echo $logradouro." N° ".$nrologradouro ; ?></font></td>
  </tr>
  <tr>
