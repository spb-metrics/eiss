...
$cart_CNPJ = $_SESSION['login'];
//verifica se tem o emissor cadastrado
$sql_cartorio = mysql_query("
	SELECT 
		codigo, 
		nome,
		razaosocial, 
	...
	WHERE 
		cnpj = '$cart_CNPJ'
");
$dados = mysql_fetch_array($sql_cartorio);

	?>

	<form id="frmGuia" method="post" name="frmDecSegundaVia" action="include/dec/gerarsegundavia.php" target="_blank">
	<input type="hidden" name="hdCodGuia" id="hdCodGuia" value="" />
		
	<table width="100%" border="0" cellpadding="0" cellspacing="1">
		<tr>
			<td height="10" bgcolor="#FFFFFF"></td>
		    <td align="center" bgcolor="#FFFFFF" rowspan="3">DEC - Segunda Via da Guia de Pagamento</td>
		...
		<tr>
			...
			<table width="98%" height="100%" border="0" align="center" cellpadding="5" cellspacing="0">
				...
				<tr>
				    ...
				    <td width="73%" align="left" valign="middle"><?php echo $cart_CNPJ; ?></td>
				</tr>
				<tr>
				  <td align="left" valign="middle">Inscri&ccedil;&atilde;o Municipal:</td>
				  <td align="left" valign="middle"><?php echo $dados['inscrmunicipal'];?></td>
			  	</tr>
				<tr>
...
<?php
		...
		$sql_guias = mysql_query("
			...
			INNER JOIN
				cartorios_des ON cartorios_des.codigo = guias_declaracoes.codrelacionamento
			INNER JOIN
				cadastro ON cadastro.codigo = cartorios_des.codcartorio 
			WHERE
				guia_pagamento.pago = 'N' AND cadastro.cnpj = '$cart_CNPJ' AND guias_declaracoes.relacionamento = 'cartorios_des'
			GROUP BY 
				codigo 
			ORDER BY 
				codigo DESC
