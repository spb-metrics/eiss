...
//SELEIONA O CODIGO DA EMPRESA
 ...
 if($_SESSION['login'] != "")
 {
  ...
  $sql_codigo_empresa=mysql_query("SELECT codigo, ultimanota FROM cadastro WHERE nome = '$NOME'");
  list($CODIGO_DA_EMPRESA,$ULTIMA_NOTA)=mysql_fetch_array($sql_codigo_empresa);
 }
...
");
list($BOLETO_BANCO, $TIPO_BOLETO)=mysql_fetch_array($sql_boleto_banco);
?>