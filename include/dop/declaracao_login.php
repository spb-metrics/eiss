...
?>
	<form method="post" name="frmDOP">
	<input type="hidden" value="inc/dop/declaracao.php" name="txtMenu">
<table border="0" cellspacing="1" cellpadding="0">
<tr>
		<td width="10" height="10" bgcolor="#FFFFFF"></td>
	    <td width="165" align="center" bgcolor="#FFFFFF" rowspan="3">DOP - Informe seu dados</td>
