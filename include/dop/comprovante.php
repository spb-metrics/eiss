...
<?php
	...
	$sql_dop=mysql_query("SELECT codigo, razaosocial, logradouro, numero, complemento, bairro, cep, municipio, uf FROM cadastro WHERE cnpj='$cnpj'");
	list($codigo,$razaosocial,$logradouro,$numero,$complemento,$bairro,$cep,$municipio,$uf)=mysql_fetch_array($sql_dop);
?>
...
<table width="800" border="0" cellspacing="0" cellpadding="5" align="center">
		...
		<td height="100" colspan="4">
			<table border="0" cellspacing="0" cellpadding="5" style="border: 0px;">
				<tr>
					...
					<td width="520" style="border:0px;" align="left" valign="middle"> <font class="prefeitura">Prefeitura Municipal de <?php echo $CIDADE; ?></font><br>
	...
	<tr>
		<td height="75" colspan="3" valign="top">
			Endere&ccedil;o:<br>
			<font class="prefeitura"><?php echo "$logradouro, $numero, $bairro, $municipio, $uf"; ?></font>
		</td>
		<td valign="top">
			CEP:<br />
			<?php echo $cep; ?>
	...
	<tr>
		<td height="200" colspan="4" align="center" valign="middle"><span class="style1">A Prefeitura Municipal de <font class="prefeitura"><?php echo $CIDADE; ?></font> certifica que &Oacute;rg&atilde;o P&uacute;blico citado acima foi devidamente cadastrado no sistema de ISSDigital do município<font class="prefeitura">
			<?php e ?>
			</font>.</span> </td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="4">
			<p>- A senha de acesso do &Oacute;rg&atilde;o P&uacute;blico ao sistema de ISSDigital do município é de uso exclusivo e intransferível do &Oacute;rg&atilde;o P&uacute;blico, bem como a responsabilidade sobre o uso indevido da mesma. </p>
		</td>
	</tr>
	<tr>
		<td height="50" colspan="4"><font class="prefeitura">
			<?php ?>
			</font>. </td>
	</tr>
</table>
