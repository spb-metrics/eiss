	...
	");
		...
		<table width="580" border="0" cellpadding="0" cellspacing="1">
	        <tr>
		        ...
		        <td width="70%" align="center" bgcolor="#FFFFFF" rowspan="3">DOP - Declaração de Orgãos Publicos dos documentos obrigatórios</td>
	  ...
	  <tr>
						<td colspan="2" align="left"><strong>Calculo para declaração dos documentos obrigatórios. </strong></td>
				</tr>
					<tr>
		...
		?>                  
				  ...
				  <tr>
					  <td align="left" valign="middle">&nbsp;</td>
					  <td align="left" valign="middle"><input type="submit" value="Declarar" class="botao" onclick="return ValidaFormulario('cmbMes|cmbAno|txtCNPJPrestador1|cmbCodServico1|txtBaseCalculo1|txtNroDoc1','O Período e pelo menos um serviço devem ser preenchidos!');" /></td>
				  </tr>
			  </table>		
			  </td>
			</tr>
