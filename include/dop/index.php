    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
            ...
            <table width="98%" height="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                ...
                <tr>
                  <td align="center">&nbsp;</td>
                  <td align="left" valign="middle"><input name="btAvancar" type="submit" value="Avançar" class="botao" onclick="return verificaCnpjCpfIm();" />&nbsp;<input type="button" name="btVoltar" value="Voltar" class="botao" onClick="window.location='dop.php'"></td>
              </tr>
          </table>		</td>
        </tr>
        <tr>
