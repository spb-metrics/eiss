...
<table width="800" border="0" cellspacing="0" cellpadding="5" align="center">
  ...
  <tr>
    <td height="200" colspan="4" align="center" valign="middle"><div class="style1">
      <blockquote>A Prefeitura Municipal de <font class="prefeitura"><?php echo $CONF_CIDADE; ?></font> certifica que a Empresa citada acima foi devidamente cadastrada no sistema de ISSDigital do município.</blockquote>
    </div>   </td>
  </tr>
  <tr>
