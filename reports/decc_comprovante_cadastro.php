...
<table width="800" border="0" cellspacing="0" cellpadding="5" align="center">
  ...
  <tr>
    <td height="200" colspan="4" align="center" valign="middle"><div class="style1">
      <blockquote>A Prefeitura Municipal de <font class="prefeitura"><?php echo $CIDADE; ?></font> certifica que a Empresa de Construção Civil citada acima foi devidamente cadastrada no sistema de ISSDigital do município.</blockquote>
    </div>   </td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="4"><p>- A senha de acesso da Empresa ao sistema de ISSDigital do município é de uso exclusivo e intransferível da Empresa, bem como a responsabilidade sobre o uso indevido da mesma.
    </p></td>
  </tr>
  <tr>
