...
<?php 
	...
	if($_GET['COD']){
		...
		$sql=mysql_query("SELECT decc_des.codigo,
                          DATE_FORMAT(decc_des.competencia,'%m/%Y') AS competencia,
                          decc_des.codverificacao,
                          cadastro.razaosocial,
                          IF(cadastro.cnpj IS NULL,cadastro.cpf,cadastro.cnpj) AS cnpjcpf,
                          cadastro.logradouro,
                          cadastro.numero,
                          cadastro.complemento,
                          cadastro.bairro,
                          DATE_FORMAT(decc_des.data,'%d/%m/%Y') AS data
                          FROM cadastro
                          INNER JOIN decc_des
                          ON decc_des.codempreiteira=cadastro.codigo
                          WHERE decc_des.codigo='$COD'"); 
...
<table width="800" border="0" cellspacing="0" cellpadding="5" align="center">
  ...
  <tr>
    <td height="30" align="center"><font class="prefeitura"><?php echo $dados['codigo']; ?></font></td>
    <td align="center"><font class="prefeitura"><?php echo $dados['codverificacao']; ?></font></td>
    <td align="center"><font class="prefeitura"><?php echo $dados['data']; ?></font></td>
    <td align="center"><font class="prefeitura"><?php echo $dados['competencia']; ?></font></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <font class="prefeitura"><?php echo $dados['razaosocial']; ?></font></td>
    <td width="25%" valign="top">CNPJ<br>
    <font class="prefeitura"><?php echo $dados['cnpjcpf']; ?></font></td>
  </tr>
  <tr>
